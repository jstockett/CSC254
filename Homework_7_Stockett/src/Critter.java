public abstract class Critter implements Comparable<Critter>{
    ...
    public String toString(){
        return String.format("Name: %-18s Id: %-5d  Health: %1.2f  Speed: %1.2f  Agility: %1.2f " +
                " Strength: %1.2f  Armor Strength: %1.2f", getName(), getId(),  getHealth(), getSpeed(),
                getAgility(), getStrength(), getArmorStrength());
    }
